...
import 'package:share_e/view/Authentication/otp_input.dart';
import 'package:share_e/model/FirebaseService.dart';
import 'package:share_e/model/SharedPreferenceHelper.dart';
import '../GoogleMap/HomeScreen.dart';
...
class OTPScreen extends StatefulWidget {
  ...
  OTPScreen({
    ...
    @required this.mobileNumber,this.username,
  })  : assert(mobileNumber != null&&username!=null),
        super(key: key);
...
class _OTPScreenState extends State<OTPScreen> {
  ...
  void _onVerifyCode() async {
    ...
    await _firebaseAuth.verifyPhoneNumber(
        phoneNumber: "+880${widget.mobileNumber}",
  ...
  void _onFormSubmitted() async {
    ...
    _firebaseAuth
      ...
      if (value.user != null) {
        ...
        await FirebaseService().setUserData(widget.username, value.user.phoneNumber,value.user.uid);
        //data storing local storage
        SharedPreferenceHelper.setLocalData(value.user.phoneNumber,widget.username,value.user.uid);
